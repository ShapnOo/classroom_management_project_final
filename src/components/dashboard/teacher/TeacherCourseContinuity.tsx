      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">{courseName} Continuity</h1>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[11px] font-bold text-slate-500 text-right">{100 - progress}% Syllabus Remaining</p>
          </div>
        </div>
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-4 mt-2">
              <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                <span className="text-sm font-medium text-slate-600">Classes Completed</span>
                <span className="text-sm font-bold text-slate-900">18 Sessions</span>
              </div>
              <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                <span className="text-sm font-medium text-slate-600">Classes Remaining</span>
                <span className="text-sm font-bold text-brand-dark">8 Sessions (Est.)</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-5 shadow-md relative overflow-hidden flex flex-col justify-between group">
          ...
          <div className="relative z-10">
            ...
            <h4 className="text-lg font-bold text-white leading-tight mb-2">Continue → BCNF Examples</h4>
            <p className="text-xs text-slate-400 mb-4">Based on continuity from Class #18</p>
          </div>
          <Link 
            href="/dashboard/teacher/sessions/start"
            className="relative z-10 inline-flex items-center justify-center gap-2 w-full py-2.5 bg-brand-dark text-white rounded-lg text-sm font-bold hover:bg-white hover:text-brand-dark transition-colors shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full">
          ...
          <div className="p-5 flex-1 flex flex-col gap-5">
            <div className="border border-slate-200 rounded-lg p-4 relative overflow-hidden">
              ...
              <h3 className="text-[10px] font-bold text-emerald-600 uppercase tracking-wider mb-2">Previous Class (Class #18)</h3>
              <p className="text-sm font-bold text-slate-900 mb-3">Topic: Normalization (3NF & Intro to BCNF)</p>
              
              <div className="space-y-1.5 mb-3">
                <p className="text-xs font-bold text-slate-500 border-b border-slate-100 pb-1 mb-2">Coverage Complete:</p>
            ...
            <div className="border border-brand-dark/20 bg-brand-dark/5 rounded-lg p-4 relative overflow-hidden">
              ...
              <h3 className="text-[10px] font-bold text-brand-dark uppercase tracking-wider mb-2">Remaining / Rollover</h3>
              
              <div className="space-y-1.5">
                <div className="flex items-start gap-2">
                  <div className="w-3.5 h-3.5 rounded-full border-2 border-brand-dark/40 mt-0.5 shrink-0"></div>
                  <span className="text-xs font-bold text-slate-800">BCNF Examples</span>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-3.5 h-3.5 rounded-full border-2 border-brand-dark/40 mt-0.5 shrink-0"></div>
                  <span className="text-xs font-bold text-slate-800">Practical Problems</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full">
          <div className="bg-slate-50 border-b border-slate-100 px-5 py-4 flex items-center justify-between">
            ...
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-white border border-slate-200 text-[10px] font-bold text-slate-600 shadow-sm">
              6 Topics Total
            </span>
          </div>
          ...
          <div className="overflow-y-auto flex-1 max-h-[360px]">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-100 text-[10px] uppercase tracking-wider text-slate-400 font-bold bg-white sticky top-0 z-10">
                ...
                {topicProgress.map((topic, i) => (
                  <tr key={i} className="hover:bg-slate-50/50 transition-colors group">
                    <td className="px-5 py-3.5">
                      <p className={`text-sm font-bold ${topic.progress === 100 ? 'text-slate-500 line-through decoration-slate-300' : 'text-slate-900'}`}>
                        {topic.topic}
                      </p>
                    </td>
                    <td className="px-5 py-3.5">
                    ...
                    <td className="px-5 py-3.5 text-right">
                      <span className={`text-xs font-bold ${topic.progress === 100 ? 'text-emerald-600' : 'text-brand-dark'}`}>
                        {topic.progress}%
                      </span>
                    </td>
                  </tr>
