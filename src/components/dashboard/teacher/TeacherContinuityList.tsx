    ...
    <div className="w-full mx-auto space-y-6 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">Course Continuity</h1>
        ...
        {mockCourses.map((course) => (
          <div key={course.id} className="bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col overflow-hidden group">
            <div className="p-5 flex-1 flex flex-col">
              ...
              <h3 className="text-base font-bold text-slate-900 mb-1 group-hover:text-brand-dark transition-colors line-clamp-1">
                {course.name}
              </h3>
              ...
              <div className="mt-auto space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-xs font-bold text-brand-dark">{course.progress}%</span>
                  </div>
                ...
                <div className="bg-amber-50 border border-amber-200/50 rounded-lg p-3 flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="text-[10px] font-bold text-amber-800 uppercase tracking-wider mb-0.5">Next Class Focus</h4>
                    <p className="text-xs font-bold text-amber-900 line-clamp-1">{course.nextTopic}</p>
                  </div>
                </div>
              </div>
