  ...
  return (
    <div className="w-full mx-auto space-y-6 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">{courseName} Students</h1>
          </div>
        </div>
        
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
          <button 
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-bold hover:bg-slate-50 transition-colors shadow-sm shrink-0"
          >
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 bg-slate-50 p-3 rounded-xl border border-slate-200">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-white border border-slate-200 flex items-center justify-center text-brand-dark font-bold text-xs shadow-sm">
            {mockStudents.length}
          </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50/50">
                ...
                <th className="px-5 py-3 text-[10px] uppercase tracking-wider text-slate-400 font-bold text-center">Attendance</th>
                <th className="px-5 py-3 text-[10px] uppercase tracking-wider text-slate-400 font-bold text-center">Assignments</th>
                <th className="px-5 py-3 text-[10px] uppercase tracking-wider text-slate-400 font-bold text-center">Avg. Marks</th>
                ...
                <tr key={student.id} className="hover:bg-slate-50/50 transition-colors group">
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-slate-900 group-hover:text-brand-dark transition-colors">
                          {student.name}
                        </p>
                  ...
                  <td className="px-5 py-3.5 text-center">
                    <span className="inline-flex items-center justify-center px-2 py-1 rounded bg-slate-100 text-xs font-bold text-slate-700">
                      {student.assignments}
                    </span>
                  </td>
                  ...
                  <td className="px-5 py-3.5 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button className="inline-flex items-center justify-center gap-1 px-3 py-1.5 bg-white border border-slate-200 text-slate-700 rounded text-xs font-bold hover:bg-slate-50 hover:text-brand-dark transition-colors shadow-sm">
