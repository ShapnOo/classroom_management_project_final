import TeacherContinuityList from "@/components/dashboard/teacher/TeacherContinuityList";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Course Continuity | Scholaris",
  description: "Track course progress, continuity, and academic timelines.",
};

export default async function CourseContinuityPage({ params }: { params: Promise<{ role: string }> }) {
  const { role } = await params;

  if (role === "teacher") {
    return <TeacherContinuityList />;
  }
